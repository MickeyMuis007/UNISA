...
#include <stdio.h>
	...
	void QObjectBrowserControl::set_children() {
        ...
        ui->children_table->horizontalHeader()->resizeSections(QHeaderView::Stretch);
	...
	void QObjectBrowserControl::set_properties() {
        ...
        ui->properties_table->horizontalHeader()->resizeSections(QHeaderView::Stretch);
	...
	void QObjectBrowserControl::set_signals() {
        ...
        ui->signals_table->horizontalHeader()->resizeSections(QHeaderView::Stretch);
	...
	void QObjectBrowserControl::set_slots() {
        ...
        ui->slots_table->horizontalHeader()->resizeSections(QHeaderView::Stretch);
	...
	void QObjectBrowserControl::set_methods() {
        ...
        ui->methods_table->horizontalHeader()->resizeSections(QHeaderView::Stretch);
